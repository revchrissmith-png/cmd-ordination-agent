  ...
  },
  {
    ...
    subsections: [
      ...
      },
      {
        ...
        blocks: [
          { type: 'p', text: 'Thank you for agreeing to be an ordination mentor. A key part of the ordination process involves the establishment of a mentor relationship. In this relationship you, as an ordained pastor, will connect regularly with a pastor working through the ordination process for the purposes of fellowship and prayer, working on the ordination requirements, planning, evaluation, and problem-solving.' },
          { type: 'p', text: 'Qualifications of an Ordination Mentor:' },
          { type: 'ul', items: [
            'Be ordained by the Christian and Missionary Alliance in Canada',
            'Possess a gift in mentorship and a passion to develop new pastors',
            'Not be in a reporting relationship to the ordinand',
            'Where possible, have (or have had) similar ministry responsibilities',
            'Be the same sex as the ordinand',
          ]},
          { type: 'p', text: 'First Meeting — establish the relationship:' },
          { type: 'ul', items: [
            'Set a schedule for when, how, and how often you will meet (in-person, video, or phone). A good guideline is 60–90 minutes per month when the ordinand is not in a cohort gathering.',
            'Review the cohort schedule and map out a plan for when assignments will be completed and how you will coach the ordinand through them.',
            'Review the "Call to Excellence" document together and ensure the ordinand fully understands its content — returning to it periodically is good practice.',
            'Ask the ordinand about ministry experiences they may struggle to access (weddings, funerals, child dedications, communion, etc.) and coach them on how to pursue those experiences.',
          ]},
          { type: 'p', text: 'Subsequent Meetings — ongoing rhythm:' },
          { type: 'ul', items: [
            'Check in on completed assignments and give constructive feedback before the ordinand submits to the council for grading.',
            'Review the most recent mentor report and discuss any questions, issues raised, or red flags.',
            'Work through a section of the ordination interview questions — coach the process of arriving at good answers, not just the answers themselves.',
            'Spend time in prayer with the ordinand.',
          ]},
          { type: 'p', text: 'Reporting:' },
          { type: 'ul', items: [
            'Ordinands submit monthly reports to their mentor only — not to the DMC or Ordaining Council.',
            'Mentors are responsible for reporting progress or concerns to the DMC and Ordaining Council at their annual check-ins, or as needed through the Assistant District Superintendent overseeing ordination.',
            'Mentors will be required to complete a mentor evaluation form before the candidate is interviewed by the ordaining council.',
            'Mentors receive a twice-yearly check-in with a member of the ordaining council to review how the mentorship is going.',
          ]},
          { type: 'callout', variant: 'tip', text: 'Helpful reminder: ordination prepares ordinands to be generalists, even if their current job title is specialist (youth, worship, children, etc.). Keep this in mind as you coach them. Encourage wide reading — ordinands should engage with theological voices that challenge their default assumptions, not only those that confirm them.' },
        ]
      },
      {
        id: 'A-8',
      ...
      },
      {
        ...
        blocks: [
          { type: 'p', text: 'Ordination is the solemn observance whereby representatives of the church corporate, together with the elders representing the local congregation, set apart and charge those persons whom God has called already and equipped for ministry, through the laying on of hands and the offering of prayer for spiritual enduement.' },
          { type: 'p', text: 'The following general directives govern the process leading to ordination in The Alliance Canada:' },
          { type: 'ul', items: [
            'The president is responsible for the Ordination Policy. Administration is the responsibility of district superintendents.',
            'The examining and ordaining body is constituted according to the Policy on District Organization.',
            'Requirements for ordination are outlined in the Ordination Requirements policy.',
            'Those who hold a portable license issued by the C&MA are required to go through the ordination process.',
            'The final decision for ordination rests with the licensing authority.',
            'Candidates must complete ordination requirements within three years of placement in ministry. Oral examination will not be conducted until a minimum of two years of service is completed.',
            'Ordained persons with acceptable ministry experience in a recognized denomination may have their ordination sustained by the ordaining council, subject to the licensing authority\'s determination of equivalency.',
            'The conducting of an ordination service and/or the conferring of the title "Reverend" may be waived at the discretion of the licensing authority.',
            'Ordination may be revoked by the C&MA at the recommendation of a discipline committee.',
            'When a person no longer bears a portable or worker emeritus license of the C&MA, their ordination is considered in abeyance — they may not claim the title, status, or functionality of ordination while unlicensed.',
          ]},
          { type: 'callout', variant: 'info', text: 'This policy was last amended by the Board of Directors in March 1996 and by General Assembly in 2012. For questions about how the national policy applies to your situation, contact the District Ministry Centre.' },
        ]
      },
      {
        id: 'A-10',
