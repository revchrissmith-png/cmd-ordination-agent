// Iteration: v2.8 - Dual-Lookup Logic (ID + Email)
'use client'
      ...
      <div className="max-w-5xl mx-auto">
        <header className="mb-12 border-b pb-6">
          ...
          <div className="mt-4 flex flex-wrap items-center gap-4">
            ...
            <span className={`px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest shadow-sm ${isAdmin ? 'bg-blue-600 text-white' : 'bg-red-100 text-red-600'}`}>
              Status: {profile ? profile.role : 'Profile Missing'}
            </span>
            <button 
