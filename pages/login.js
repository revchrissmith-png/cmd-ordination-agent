...
export default function LoginPage() {
  ...
  return (
    <div style={{ backgroundColor: '#EAEAEE', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'sans-serif' }}>
      <Head><title>Login | CMD Study Agent</title></Head>
      <div style={{ backgroundColor: 'white', padding: '3rem', borderRadius: '12px', boxShadow: '0 10px 30px rgba(0,0,0,0.1)', textAlign: 'center', maxWidth: '400px', width: '90%' }}>
        ...
        <h1 style={{ color: '#00426A', fontSize: '1.2rem', marginBottom: '2rem', fontWeight: 'bold' }}>CMD STUDY AGENT</h1>
        <button 
        ...
        >
          <img src="https://www.gstatic.com/firebasejs/ui/2.0.0/images/auth/google.svg" alt="G" style={{ height: '18px' }} />
          Sign in with Google
        </button>
      </div>
    </div>
